...
import sys
# sys.path.append('D:\demo\Code\DPA')
# print(sys.argv[0])
import os
# print(os.path.dirname(__file__))
current = os.path.join(os.getcwd(),'DPA')
import sys
import math
import DPA.model as model
import torch
import requests
import pickle
import numpy as np
...
fingerprint_dict = model.load_pickle(os.path.join(current,'Data/input/fingerprint_dict.pickle'))
atom_dict = model.load_pickle(os.path.join(current,'Data/input/atom_dict.pickle'))
bond_dict = model.load_pickle(os.path.join(current,'Data/input/bond_dict.pickle'))
edge_dict = model.load_pickle(os.path.join(current,'Data/input/edge_dict.pickle'))
word_dict = model.load_pickle(os.path.join(current,'Data/input/sequence_dict.pickle'))
...
def main() :
    ...
    with open(os.path.join(current,'input.tsv'), 'r') as infile :
    ...
    Kcat_model.load_state_dict(torch.load((os.path.join(current,'Results/output/all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50')), map_location=device))
    ...
    with open('./DPA/output.tsv', 'w') as outfile :
