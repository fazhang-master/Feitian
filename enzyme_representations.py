...
CURRENT_DIR = join(os.getcwd(), 'TurNuP/code')
...
def calcualte_esm1b_ts_vectors(enzyme_list):
	...
	# print(join(CURRENT_DIR,"code","data", "data", "saved_models", "ESM1b", "esm1b_t33_650M_UR50S.pt"))
	model_location = join(CURRENT_DIR,"data", "data", "saved_models", "ESM1b", "esm1b_t33_650M_UR50S.pt")
	# model_location = 'F:\desktop\demo\Kcat生物信息\kcat_prediction_function\kcat_prediction_function-main\code\data\data\saved_models\ESM1b\esm1b_t33_650M_UR50S.pt'

	model_data = torch.load(model_location, map_location='cpu')
	# model_data = torch.load(model_location, map_location='gpu')
	...
	model.eval()
	PATH = join(CURRENT_DIR, "data", "data","saved_models", "ESM1b", 'model_ESM_binary_A100_epoch_1_new_split.pkl')
	model_dict = torch.load(PATH, map_location=torch.device('cpu'))
	# model_dict = torch.load(PATH, map_location=torch.device('gpu'))
